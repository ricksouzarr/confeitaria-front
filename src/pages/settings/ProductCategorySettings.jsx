...
export default function ProductCategorySettings() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (editingId) {
                await api.put(`/product-categories/${editingId}`,
                    { nome, ativo: true });
                setSuccess("Categoria atualizada.");
            } else {
                await api.post("/product-categories", { nome, ativo: true });
    ...
    return (
        <MainLayout
            ...
            subtitle="Gerencie as categorias disponíveis para os produtos"
        >
